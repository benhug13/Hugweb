        ...
        <section id="leistungen" className="relative py-24 md:py-32 border-y border-white/10 bg-[#080706] overflow-hidden">
          ...
          <div className="relative max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-12 gap-8 items-end">
              ...
              <Reveal delay={0.1} className="md:col-span-5">
                <p className="text-white/60 leading-relaxed">Von der einzelnen Fliese bis zur XXL-Grossfläche: Wir übernehmen jedes Plattenprojekt — drinnen wie draussen, in Keramik, Naturstein oder Mosaik.</p>
              </Reveal>
            </div>
            ...
            <Reveal className="h-full">
              <div className="h-full min-h-[22rem] overflow-hidden rounded-2xl border border-white/10">
                <img src={IMG_KERAMIK} alt="Feinsteinzeug-Arbeit" className="h-full w-full object-cover transition duration-700 hover:scale-[1.03]" />
              </div>
            </Reveal>
