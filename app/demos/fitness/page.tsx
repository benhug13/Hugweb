  ...
  return (
    <>
      ...
      <div className="bg-[#0b0d10] text-white">
        ...
        <section id="programme" className="py-16 md:py-20">
        ...
        <section id="plan" className="py-16 md:py-20 border-t border-white/5">
          <div className="w-full max-w-7xl mx-auto px-6">
            <Reveal>
        ...
        <section id="preise" className="py-16 md:py-20 border-t border-white/5">
          <div className="w-full max-w-7xl mx-auto px-6">
            <Reveal>
